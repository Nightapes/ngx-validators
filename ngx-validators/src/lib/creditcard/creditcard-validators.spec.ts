  ...
  describe('creditcard', () => {
    ...
    it('should work for creditcard number (americanExpress)', () => {
      americanexpress.forEach((element) => {
        ...
        expect(CreditCardValidators.isCreditCard(control)).toBeNull();
        expect(CreditCardValidators.americanExpress(control)).toBeNull();
        expect(CreditCardValidators.dinersclub(control)).toEqual({
          dinersclub: true,
        });
        expect(CreditCardValidators.discover(control)).toEqual({
          discover: true,
        });
        expect(CreditCardValidators.jcb(control)).toEqual({ jcb: true });
        expect(CreditCardValidators.maestro(control)).toEqual({
          maestro: true,
        });
        expect(CreditCardValidators.mastercard(control)).toEqual({
          mastercard: true,
        });
    ...
    it('should work for creditcard number (visa)', () => {
      visa.forEach((element) => {
        const control: FormControl = new FormControl(element);
        expect(CreditCardValidators.isCreditCard(control)).toBeNull();
        expect(CreditCardValidators.americanExpress(control)).toEqual({
        ...
        expect(CreditCardValidators.visa(control)).toBeNull();
      });
    });
    ...
    it('should work for creditcard number (dinersclub)', () => {
      dinersclub.forEach((element) => {
        ...
        expect(CreditCardValidators.dinersclub(control)).toBeNull();
        expect(CreditCardValidators.discover(control)).toEqual({
          discover: true,
        });
        expect(CreditCardValidators.jcb(control)).toEqual({ jcb: true });
    ...
    it('should work for creditcard number (discover)', () => {
      discover.forEach((element) => {
        ...
        expect(CreditCardValidators.discover(control)).toBeNull();
        expect(CreditCardValidators.jcb(control)).toEqual({ jcb: true });
        expect(CreditCardValidators.maestro(control)).toEqual({
          maestro: true,
        });
    ...
    it('should work for creditcard number (jcb)', () => {
      jcb.forEach((element) => {
        ...
        expect(CreditCardValidators.jcb(control)).toBeNull();
        expect(CreditCardValidators.maestro(control)).toEqual({
          maestro: true,
        });
        expect(CreditCardValidators.mastercard(control)).toEqual({
    ...
    it('should work for creditcard number (maestro)', () => {
      maestro.forEach((element) => {
        ...
        expect(CreditCardValidators.jcb(control)).toEqual({ jcb: true });
        expect(CreditCardValidators.maestro(control)).toBeNull();
        expect(CreditCardValidators.mastercard(control)).toEqual({
          mastercard: true,
        });
        expect(CreditCardValidators.visa(control)).toEqual({ visa: true });
    ...
    it('should work for creditcard number (mastercard)', () => {
      mastercard.forEach((element) => {
        ...
        expect(CreditCardValidators.mastercard(control)).toBeNull();
        expect(CreditCardValidators.visa(control)).toEqual({ visa: true });
      });
    });
