  ...
  implements Validator, OnInit, OnChanges
{
  ...
  ngOnInit() {
    ...
    this.alphabeticalCharacterValidator =
      PasswordValidators.alphabeticalCharacterRule(this.alphabeticalCharacter);
    this.digitCharacterValidator = PasswordValidators.digitCharacterRule(
      this.digitCharacter
    );
    this.lowercaseCharacterValidator =
      PasswordValidators.lowercaseCharacterRule(this.lowercaseCharacter);
    this.uppercaseCharacterValidator =
      PasswordValidators.uppercaseCharacterRule(this.uppercaseCharacter);
  }
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (changes['lowercaseCharacter']) {
      ...
      inputChanged = changes['lowercaseCharacter'].isFirstChange()
        ? false
        : true;
    }
    ...
    if (changes['uppercaseCharacter']) {
      ...
      inputChanged = changes['uppercaseCharacter'].isFirstChange()
        ? false
        : true;
    }
