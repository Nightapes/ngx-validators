...
describe('Universal validators service', () => {
  ...
  describe('maxDate', () => {
    ...
    it('should work for invalid maxDate', () => {
      ...
      expect(validated).toEqual({
        maxDate: { required: requiredDate, actual: currentDate },
      });
    });
  });
  ...
  describe('minDate', () => {
    ...
    it('should work for valid minDate', () => {
      ...
      const validated = UniversalValidators.minDate(new Date('2012-12-24'))(
        control
      );
      expect(validated).toBeNull();
    });
    ...
    it('should work for invalid minDate', () => {
      ...
      expect(validated).toEqual({
        minDate: { required: requiredDate, actual: currentDate },
      });
    });
  });
  ...
  describe('type', () => {
    it('should allow empty input', () => {
      expect(
        UniversalValidators.type('number')(new FormControl(''))
      ).toBeNull();
      expect(
        UniversalValidators.type('string')(new FormControl(''))
      ).toBeNull();
      expect(
        UniversalValidators.type('object')(new FormControl(''))
      ).toBeNull();
      expect(
        UniversalValidators.type('boolean')(new FormControl(''))
      ).toBeNull();
    });
    ...
    it('should check for number type', () => {
      ...
      expect(
        UniversalValidators.type('number')(new FormControl('str'))
      ).toEqual({
        type: { required: 'number', actual: 'string' },
      });
      expect(
        UniversalValidators.type('number')(new FormControl({ key: 'value' }))
      ).toEqual({
    ...
    it('should check for string type', () => {
      expect(
        UniversalValidators.type('string')(new FormControl('str'))
      ).toBeNull();
      expect(UniversalValidators.type('string')(new FormControl(1))).toEqual({
        type: { required: 'string', actual: 'number' },
      });
      expect(
        UniversalValidators.type('string')(new FormControl({ key: 'value' }))
      ).toEqual({
    ...
    it('should check for boolean type', () => {
      expect(
        UniversalValidators.type('boolean')(new FormControl(true))
      ).toBeNull();
      expect(UniversalValidators.type('boolean')(new FormControl(1))).toEqual({
        type: { required: 'boolean', actual: 'number' },
      });
      expect(
        UniversalValidators.type('boolean')(new FormControl({ key: 'value' }))
      ).toEqual({
        type: { required: 'boolean', actual: 'object' },
      });
      expect(
        UniversalValidators.type('boolean')(new FormControl('str'))
      ).toEqual({
    ...
    it('should check for object type', () => {
      expect(
        UniversalValidators.type('object')(new FormControl({ key: 'value' }))
      ).toBeNull();
      ...
      expect(
        UniversalValidators.type('object')(new FormControl('str'))
      ).toEqual({
